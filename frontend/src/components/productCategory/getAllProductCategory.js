...
function CustomTable({ list, total, fetchAllProductCategory }) {
      ...
      <div className="card-body">
        ...
        <Table
          ...
          pagination={{
            ...
            onChange: (page, limit) => {
              fetchAllProductCategory({ page, limit });
            },
          }}
...
const GetAllProductCategory = (props) => {
  ...
  const fetchAllProductCategory = useCallback((props) => {
  ...
  return <CustomTable list={list} fetchAllProductCategory={fetchAllProductCategory} />;
};
